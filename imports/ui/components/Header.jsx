                        ...
                        {!signedInAddress? <NavItem>
                            ...
                            <span className="d-none d-lg-block">
                                ...
                                <UncontrolledPopover className="d-none d-lg-block" trigger="legacy" placement="bottom" target="user-acconut-icon">
                                    <PopoverBody>
                                        <div><T>ledger.signInText</T></div>
                                        <div className="overflow-auto"><Link className="text-nowrap" to={`/account/${signedInAddress}`}>{signedInAddress}</Link></div>
                                        <Button className="float-right" color="link" onClick={this.signOut.bind(this)}><i className="material-icons">exit_to_app</i><span> <T>ledger.signOut</T></span></Button>
                                    </PopoverBody>
                                </UncontrolledPopover>
                            </span>
                        </NavItem>}
